...
add_submenu_page('kentopvc_settings', __('Kento PVC Stats Geo','menu-test'), __('Stats Geo','menu-test'), 'manage_options', 'kento_pvc_settings_stats_geo', 'kento_pvc_settings_stats_geo');
