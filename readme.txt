...
* Add refer site where visitors come from(new).
...
`[kpvc_single today_text="hello today" total_text="hello total"]`<br />



<br />

<strong>How to use shortcodes in loop or excerpt ?</strong><br />
...
<strong>Display Custom text for today or total views count</strong><br />
`<?php do_shortcode('[kpvc_loop post_id='.get_the_ID().' today_text="hello today" total_text="hello total" ] '); ?>`<br />
