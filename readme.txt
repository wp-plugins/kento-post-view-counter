...
* Display Geo Stats via shortcode for top 20 city or country(NEW).
...
* Display via shortcodes only today's count or total count or both.
* refer site list where visitors come from.
...
<br /><br />
<strong>How to display Geo Stats Via Shortcodes ?</strong><br />
...
= 2.2 =
* Add Widget Via shorcode to display Top 20 City or Country Geo Stats anywhere post or page
